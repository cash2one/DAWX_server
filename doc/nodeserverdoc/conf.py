...
htmlhelp_basename = 'nodeserverdoc'
...
latex_documents = [
  (master_doc, 'nodeserver.tex', u'nodeserver Documentation',
   u'Author', 'manual'),
]
...
man_pages = [
    (master_doc, 'nodeserver', u'nodeserver Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'nodeserver', u'nodeserver Documentation',
   author, 'nodeserver', 'One line description of project.',
   'Miscellaneous'),
]
